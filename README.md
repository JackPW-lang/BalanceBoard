...
The documentation follows in the next sections of this README. If you prefer to view the full LaTeX-based documentation as a PDF, you can access it [here](BalanceBoard_Documentation-4.pdf)
