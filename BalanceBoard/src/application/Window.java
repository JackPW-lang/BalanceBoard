...
public abstract class Window {
    ...
    public Window(Stage stage, User user) {
        this.stage = stage;
        this.scene = new Scene(createContent(user), 800, 600, Color.BLACK); // parameters: Parent (root node of Scene Graph), width, height.
        this.user = user;
    ...
    public abstract Parent createContent(User u);
}
